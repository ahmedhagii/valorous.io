class SolutionsLayer
	...
	def self.execute lang, code, student_id, problem_id, class_name, cases
		executer = get_executer lang
		unless executer
			return false
		end
		compiler = get_compiler lang
		solution = get_solution code, student_id, problem_id, class_name
		compile_status = {}
		if compiler
	...
	#	The compile status
	# Author: Mussab ElDash
	def self.compile lang, code, student_id, problem_id, class_name
		compiler = get_compiler lang
		solution = get_solution code, student_id, problem_id, class_name
		if compiler
	...
	# Author: Mussab ElDash
	def self.validate lang, code, student_id, problem_id, class_name, time
		solution = get_solution code, student_id, problem_id, class_name
		solution.time = time
	...
	# Author: Mussab ElDash
	def self.debug lang, code, student_id, problem_id, class_name, cases
		solution = get_solution code, student_id, problem_id, class_name
	...
	#	A new Solution
	# Author: Mussab ElDash
	def self.get_solution code, student_id, problem_id, class_name, problem_type = "Problem"
